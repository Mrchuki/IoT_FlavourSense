# python3 iot-hub-client-message.py "HostName=icaiiotflavoursense.azure-devices.net;DeviceId=SenseHat;SharedAccessKey=1zTmZeEfAeDwV7P7gf2ERKkiG1F/2mG79ou5RM8BYlA="
...
def aux_validate_connection_string():
    if not AUX_CONNECTION_STRING.startswith("HostName="):
        ...
        print(
            "FORMAT - HostName=your_iot_hub_name.azure-devices.net;DeviceId=your_device_name;SharedAccessKey=your_shared_access_key"
        )
        sys.exit()
